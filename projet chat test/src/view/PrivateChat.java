...
public class PrivateChat extends javax.swing.JFrame {
    ...
    public String recieveFromServer() {
        try {
            ...
            System.out.println("[recieveFromServer()] Serveur n'est pas ouvert, ou encore férmé!");
        } catch (IOException ex) {
            Logger.getLogger(PrivateChat.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    ...
    public void insertButton(String sender, String fileName) {
        ...
        appendMessage_Left(sender, " Envoie de fichier ", "#00dddd", "#00ee11");
    ...
    private void downloadFile(String buttonName) {
        ...
        if(kq == JFileChooser.APPROVE_OPTION) {
            ...
            myDownloadFolder = "D:";
            JOptionPane.showMessageDialog(this, "Location par defaut D:\\", "Notice", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        try {
            ...
            System.out.println("commencer a recevoir de fichier");
        } catch (IOException ex) {
            Logger.getLogger(PrivateChat.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        btSend_pc.setBackground(new java.awt.Color(255, 255, 255));
        btSend_pc.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btSend_pc.setForeground(new java.awt.Color(0, 102, 102));
        btSend_pc.setText("Envoie");
        ...
        btFile_pc.setBackground(new java.awt.Color(255, 255, 255));
        btFile_pc.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btFile_pc.setForeground(new java.awt.Color(0, 102, 102));
        btFile_pc.setText("Fichier");
